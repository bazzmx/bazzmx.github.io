...
#from spacy.lang.en import LEMMA_INDEX, LEMMA_EXC, LEMMA_RULES # inglés!
from spacy.lang.es import LOOKUP
import sense2vec
...
print("Loading")
LEMMATIZER = Lemmatizer(LOOKUP)

#LEMMATIZER = Lemmatizer(LEMMA_INDEX, LEMMA_EXC, LEMMA_RULES)

S2V = sense2vec.load('bin_files')
print("Loaded!")
